...
public class InsertTest {
	...
	public void testInsert1(){
		...
		try {
			...
			System.out.println("花费的时间为：" + (end - start));//21834
		} catch (Exception e) {
			e.printStackTrace();
		}finally {
...
//			for(int i = 1;i <= 20000;i++){
			...
			long end = System.currentTimeMillis();
			System.out.println("花费的时间为：" + (end - start));//21834 -- 480
		} catch (Exception e) {								//1000000:18423——牛皮！！！100万数据18s就插入完了
			e.printStackTrace();
		}finally{
			JDBCUtils.closeResource(conn, ps);
